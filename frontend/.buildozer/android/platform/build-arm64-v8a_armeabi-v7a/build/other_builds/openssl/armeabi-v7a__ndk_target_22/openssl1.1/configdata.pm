...
our %config = (
  ...
  CFLAGS => [ "-target armv7a-linux-androideabi22 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=22" ],
  CPPFLAGS => [ "-DANDROID -I/home/andre/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/andre/Documents/Development/Python/Kivy/ktk_app/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/ktk_pacakage/armeabi-v7a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/andre/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi22 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-target armv7a-linux-androideabi22 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/home/andre/Documents/Development/Python/Kivy/ktk_app/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/libs_collections/ktk_pacakage/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)armv7a-linux-androideabi22-clang",
  minor => "1.1",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/andre/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
